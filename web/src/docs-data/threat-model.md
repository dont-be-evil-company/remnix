---
title: Threat model
excerpt: What remnix detects, prevents, and accepts on untrusted remotes.
description: Threat classifications for rollback, replay, tampering, and other attacks against remnix remotes.
order: 4
---
